...
export default function MenuLateral() {
  return (
    <aside className='flex flex-col bg-gray-200 text-gray-700 dark:bg-gray-900'>
      ...
      <ul >
        <MenuItem  texto="Sair" icone={IconeSair} onClick={() => console.log("logout")} className='text-red-600 dark:text-red-400 hover:bg-red-400 hover:text-white dark:hover:text-white'/>
      </ul>
    </aside>
  );
}
